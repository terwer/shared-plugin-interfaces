...
```
mvn install:install-file -Dfile=target/shared-plugin-interfaces-1.2.0.jar -DgroupId=com.terwergreen -DartifactId=shared-plugin-interfaces -Dversion=1.2.0 -Dpackaging=jar
```
