...
```
mvn install:install-file -Dfile=target/shared-plugin-interfaces-3.0.7.jar -DgroupId=com.terwergreen -DartifactId=shared-plugin-interfaces -Dversion=3.0.7 -Dpackaging=jar
```
