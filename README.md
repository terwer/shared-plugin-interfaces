...
```
mvn install:install-file -Dfile=target/shared-plugin-interfaces-4.1.0.jar -DgroupId=com.terwergreen -DartifactId=shared-plugin-interfaces -Dversion=4.1.0 -Dpackaging=jar
```
