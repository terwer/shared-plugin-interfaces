...
```
mvn install:install-file -Dfile=target/shared-plugin-interfaces-3.2.2.jar -DgroupId=com.terwergreen -DartifactId=shared-plugin-interfaces -Dversion=3.2.2 -Dpackaging=jar
```
