...
```
mvn install:install-file -Dfile=target/shared-plugin-interfaces-3.1.0.jar -DgroupId=com.terwergreen -DartifactId=shared-plugin-interfaces -Dversion=3.1.0 -Dpackaging=jar
```
