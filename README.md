...
```
mvn install:install-file -Dfile=target/shared-plugin-interfaces-3.0.6.jar -DgroupId=com.terwergreen -DartifactId=shared-plugin-interfaces -Dversion=3.0.6 -Dpackaging=jar
```
