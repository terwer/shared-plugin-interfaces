...
```
mvn install:install-file -Dfile=target/shared-plugin-interfaces-3.0.1.jar -DgroupId=com.terwergreen -DartifactId=shared-plugin-interfaces -Dversion=3.0.1 -Dpackaging=jar
```
